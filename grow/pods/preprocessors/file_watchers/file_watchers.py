...
# TODO(jeremydw): Support other file watchers.
#import inotify_file_watcher
import mtime_file_watcher
#import win32_file_watcher
...
def get_file_watcher(directories, use_mtime_file_watcher=False):
